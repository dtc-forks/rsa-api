...
/**
 * Key encoding exception.
 *
 * @author Søren Thalbitzer Poulsen
 */
public class KeyEncodingException extends KeyException {

    /**
     * Constructs a new KeyEncodingException with null as its detail message.
     */
    public KeyEncodingException() {
    }

    /**
     * Constructs a new KeyEncodingException with the specified detail message and cause.
     *
     * @param msg Message
     */
    public KeyEncodingException(String msg) {
        super(msg);
    }
     ...
     * @param cause Cause.
     */
    public KeyEncodingException(String msg, Throwable cause) {
        super(msg, cause);
    }
